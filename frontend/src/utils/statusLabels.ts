...
export const statusLabels: Record<string, string> = {
  ...
  banco_futuro: "Banco de Currículos",
  banco_talentos: "Banco de Currículos",
  sugerido_para_vaga: "Sugerido para vaga",
  pausado: "Pausado",
  desatualizado: "Desatualizado",
  arquivado: "Arquivado",
  pendente_revisao: "Pendente de revisão do SINE",
  aprovado_pelo_sine: "Aprovado pelo SINE",
  recusado_pelo_sine: "Recusado pelo SINE",
  expirado: "Expirado",
