...
describe("SineJobTriagePage", () => {
  beforeEach(() => {
    vi.mocked(api.get).mockImplementation((url: string) => {
      if (url === "/jobs") return Promise.resolve({ data: [{ id: "job-1", company_id: "company-1", title: "Atendente", description: "Atendimento", vacancies: 1, status: "publicada", created_at: "2026-05-20T00:00:00Z" }] });
